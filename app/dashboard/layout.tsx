  ...
  return (
    <div className="min-h-screen w-full max-w-full overflow-x-hidden bg-[#f5f7fb]">
      ...
      <main className="dashboard-main min-w-0 max-w-full md:ml-72 md:h-screen md:w-[calc(100%_-_18rem)] md:overflow-y-auto">
        <div className="w-full min-w-0 max-w-full overflow-x-hidden px-4 pt-[calc(env(safe-area-inset-top)+1rem)] pb-[calc(env(safe-area-inset-bottom)+112px)] md:px-6 md:pt-6 md:pb-8 lg:px-8 lg:pt-8">
          {children}
        </div>
      </main>
      <MobileBottomNav />
