...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "max-w-full overflow-hidden rounded-[24px] border bg-card text-card-foreground shadow-[0_24px_64px_-44px_rgba(15,23,42,0.42)]",
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <h3
    ref={ref}
    className={cn("leading-tight tracking-tight text-slate-950", className)}
    {...props}
  />
));
